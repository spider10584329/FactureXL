export const translations = {
  en: {
    ...
    editSubscriptionInvoice: "Edit subscription invoice",
    selectMonths: "Select months",
    subscriptionCreated: "Subscription invoice created successfully",
    subscriptionUpdated: "Subscription invoice updated successfully",
    subscriptionDeleted: "Subscription invoice deleted successfully",
    noSubscriptionFound: "No subscription invoice found",
    deleteSubscription: "Delete subscription invoice",
    deleteSubscriptionConfirm: "Are you sure you want to delete this subscription invoice?",
    frequency: "Frequency",
    weekly: "Weekly",
    monthly: "Monthly",
    quarterly: "Quarterly",
  ...
  fr: {
    ...
    newSubscriptionInvoice: "Nouvelle facture abonnement",
    editSubscriptionInvoice: "Modifier la facture abonnement",
    selectMonths: "Selectionner les mois",
    subscriptionCreated: "Facture abonnement creee avec succes",
    subscriptionUpdated: "Facture abonnement mise a jour",
    subscriptionDeleted: "Facture abonnement supprimee",
    noSubscriptionFound: "Aucune facture abonnement trouvee",
    deleteSubscription: "Supprimer la facture abonnement",
    deleteSubscriptionConfirm: "Voulez-vous vraiment supprimer cette facture abonnement?",
    frequency: "Frequence",
    weekly: "Hebdomadaire",
    monthly: "Mensuel",
